...
public class ClientTest {
	...
	public static void main(String[] args) {
		try (Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			/*
			 * persist() -> This method is used save an entity/object into database and
			...
			/*
			 * save() -> This method is used save an entity/object into database and return
			 * generated primary key. It will throw an exception if an entity already exists
			 * in the database.
			 */
